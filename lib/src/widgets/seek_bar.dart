...
class SeekBar extends StatefulWidget{
  ...
  const SeekBar({Key key, this.progressWidth, this.thumbRadius, this.value, this.secondValue, this.barColor, this.progressColor, this.secondProgressColor=const Color(0xBBFFFFFF), this.thumbColor, this.onStartTrackingTouch, this.onProgressChanged, this.onStopTrackingTouch}) : super(key: key);
  @override
...
class _SeekBarPainter extends CustomPainter{
  ...
  _SeekBarPainter({this.progressWidth, this.thumbRadius, this.value, this.secondValue, this.barColor, this.progressColor, this.secondProgressColor, this.thumbColor, this.touchDown});
